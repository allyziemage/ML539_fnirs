# -*- coding: utf-8 -*-
"""
Created on Mon Nov 30 09:25:41 2020
...
X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.5, random_state=42)#test_size specifies percetage of split between test and train
